...
class GridBagLayoutBehaviorTest {
	...
	KeyType keytype;
	GridBagLayoutBehavior gridBagLayoutBehavior;
	Component comp;
	
	@BeforeEach
	void setup() throws Exception{
		gridBagLayoutBehavior = new GridBagLayoutBehavior();
	...
	void updateLayoutBehaviorTest() {
		...
		gridBagLayoutBehavior.updateLayoutBehavior(abstractPanel, 100, 100);
